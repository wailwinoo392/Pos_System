    ...
    <div class="section__content section__content--p30">
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-8">
                    <div class="p-3">
                        <h3 class="text-center title-2">Message To Customer</h3>
                        <hr>
                    </div>
                    <div class="mx-3">
                        <form action="{{route('admin#createMessage')}}" method="post">
                          @csrf
                          <small class="mb-3 px-5">{{ $messageList->appends(request()->query())->links()}}</small>
                          <ul class="list-unstyled">
                                ...
                                <div class="card w-100 ms-5 ">
                                  ...
                                  <div class="card-body deleteAlert">
                                    ...
                                    <small class="text-muted float-end">
                                      <input type="hidden" id="messagee" value="{{$item->message}}">
                                      <input type="hidden" name="messageId" id="messageId" value="{{$item->id}}">
                                      <input type="hidden" id="adminMessageEdit" name="" value="Edit">
                                        <a href="#" onclick="return false;" class="me-1 text-muted adminMessageEdit" >@if($item->created_at == $item->updated_at) Edit @else Edited @endif</a>
                                        <a href="#" onclick="return false;" class="text-muted adminMessageDelete" id="" >Delete</a>
                                    </small>
                                  </div>
                                </div>
                            ...
                            <li class=" mb-3" id="messageEditField">
                              <div class="form-outline">
                                <textarea class="form-control bg-white" placeholder="Enter Message" id="textAreaExample2" name="contactMessage" rows="4" required></textarea>
                ...
                <div class="col-md-4 bg-light p-3 ">
                    <h5 class="text-center">Unread Message List</h3>
                    <ul class="list-unstyled navbar__list js-scrollbar1">
                        ...
                        <li>
                            <div class="notifi__item">
                                ...
                                <a href="{{route('admin#messageList',$item->user_id)}}" class="content text-decoration-none">
                                    <div class="d-flex align-items-center justify-content-between text-dark">
                                        <label class="" for="price-all">{{$item->user_name}}<span class="badge border font-weight-normal text-dark ms-1">{{$item->unread_count}}</span></label>
